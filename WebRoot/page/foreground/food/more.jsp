...
<%	
		...
		String sql = "select price,Rname,images from restaurant where num="+num;
		ResultSet rs = null;
		String name = null;
		String image = null;
		float i=0;
...
.fivestars div{background-position:left top; width:0px;}
  ...
  <div class="header_nav">
    	...
    	<h2 style="float:left;margin-top:20px"><%=name %> </h2><br><br><br><br><br>
    	
    	<div class="fivestars" id="fivestars"><div class="autostars" id="autostars" style="width: <%=i*26%>px">&nbsp;</div></div>
 
    	<br><br>
    	<p style="color:green;font-size:16px;float:left">在北理10家餐馆中排<b><%=num %></b></p><br><br>
     ...
     marigin-top:100px;   	        	
        	        	">
        	        	<img src=<%=image%> width="270px"  height="240px" style="margin-top:15px; margin-bottom: auto;"></img> 
        	        	</div>
