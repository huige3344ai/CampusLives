...
<html>
 ...
 <div id="contents">               
        <div id="usermessage"> 
        <div id = "headphoto">
        <img src="images/head sculpture.jpg"></div>
...
<h3>拾到物名称：<input type = "text" name="findname" style="width:300px;height:30px;"/> </h3>
<br>
<br>
<h3>拾到者姓名：<input type = "text" name="findername" style="width:300px;height:30px;"/> </h3>
<br>
<br>
<h3>拾到物详细信息：（不超过100字）<input type="text" name="description"  style="width: 100%; height: 100px"/></h3>
<br>
<br>
<h3>拾到者地址：<input type = "text" name="address" style="width:100%;height:30px;"/> </h3>
<br>
<br>
<h3>拾到者电话：<input type = "text" name="tel" style="width:300px;height:30px;"/> </h3>
<br>
<br>
<br>
<br><input type="text" name="promulgator" readonly="readonly" value="<%= session.getAttribute("uname") %>"/>
<center> <input type = "submit" style="width:200px;height:40px;"  value ="递交信息" name = "submit"/></center></form>
  </fieldset>
