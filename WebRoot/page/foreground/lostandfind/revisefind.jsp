...
<form action ="revisefindservlet" method = "post"> 

 <%
              request.setCharacterEncoding("utf-8");
              response.setCharacterEncoding("utf-8");
          int id=((Integer)request.getAttribute("id")).intValue();  
	       Vector V=(Vector)useDao.idData("find_message",id);//vector
   			Iterator it=V.iterator();
   			 Vector v=(Vector)it.next();
            %>
<h3>拾到物名称：<input type = "text" name="findname" value="<%=v.get(2).toString()%>" style="width:300px;height:30px;"/> </h3>
<br>
<br>
<h3>拾到者姓名：<input type = "text" name="findername" value="<%=v.get(1).toString()%> "style="width:300px;height:30px;"/> </h3>
<br>
<br>
<h3>拾到物详细信息：（不超过100字）<input type="text" name="description" value="<%=v.get(3).toString()%>" style="width: 100%; height: 100px"/></h3>
<br>
<br>
<h3>拾到者地址：<input type = "text" name="address" value="<%=v.get(4).toString()%>" style="width:100%;height:30px;"/> </h3>
<br>
<br>
<h3>拾到者电话：<input type = "text" name="tel" value="<%=v.get(5).toString()%>" style="width:300px;height:30px;"/> </h3>
<br>
<br>
<br>
