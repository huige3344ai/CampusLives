         ...
         <div id="body">
                ...
                <div class = "user">
                 ...
                 <%=session.getAttribute("uname")%>,<a href="page/foreground/logout.jsp">注销</a>
     			 ...
     			 <form action="http://localhost:8080/CampusLives/page/PointView/background/PointShow.jsp" method="post" id="form" onSubmit="return validate()">
     			 <fieldset>
     			 ...
     			 <table>
     			  <tr>
     			 <td>
     			 <input name="hi" type="submit" value="查询" ></input></td><td>
