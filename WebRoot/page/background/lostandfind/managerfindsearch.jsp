 ...
 <div id="contents">               
     ...
     <center> <%= session.getAttribute("username") %></center>
       ...
       <legend align="center" ><h3>可选服务</h3></legend>
        <form action ="page/background/lostandfind/managerfindsearch.jsp" method = "post">
        <center> <input type = "submit" style="width:200px;height:40px;"  value ="拾到物登记管理" name = "find"/></center>
        </form>
        
         <form action ="page/background/lostandfind/managerlostsearch.jsp" method = "post">
...
<table align="center" border="1">
           ...
           <tbody>
                <tr><td width=25>编号</td><td width=75>拾到物名称</td>  <td width=75>拾到者姓名</td>   <td width=225>物品描述</td>    <td width=100>拾到者地址</td> <td width=100>拾到者电话</td>  <td width=50>发布者</td></tr> 

     <%
              request.setCharacterEncoding("utf-8");
              response.setCharacterEncoding("utf-8");
              
             String sql="select * from find_message";/////////////////////////
	      ...
	      <label ><%=v.get(0).toString() %></label></td>
            ...
            <td><a  href="revisedataserlet?findre_id=<%=v.get(0).toString()%>" title="修改" >修改</a></td>
               <td><a  href="deletedataserlet?find_id=<%=v.get(0).toString()%>" title="删除" >删除</a></td>
             <%
              }
